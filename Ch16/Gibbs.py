...
def pb_ras(values):
    if np.random.rand() < values[1] * values[2] * 0.0698 + values[1] * (1 - values[2]) * 0.4030 + (1 - values[1]) * \
            values[2] * 0.4118 + (1 - values[1]) * (1 - values[2]) * 0.8630:
        values[0] = 1
    else:
        values[0] = 0
    return values
...
def pr_bas(values):
    y = np.random.rand(1)
    if np.random.rand() < values[0] * values[2] * (1 - values[3]) * 0.5172 + values[0] * (1 - values[2]) * values[
        3] * 0.2553 + values[0] * (1 - values[2]) * (1 - values[3]) + (1 - values[0]) * values[2] * (
        1 - values[3]) * 0.9091 + (1 - values[0]) * (1 - values[2]) * values[3] * 0.7619 + (1 - values[0]) * (
...
def pa_brs(values):
    if np.random.rand() < values[0] * values[1] * (1 - values[3]) * 0.3571 + values[0] * (1 - values[1]) * values[
        3] * 0.0629 + values[0] * (1 - values[1]) * (1 - values[2]) + (1 - values[0]) * values[1] * (
        1 - values[3]) * 0.8333 + (1 - values[0]) * (1 - values[1]) * values[3] * 0.375 + (1 - values[0]) * (
...
def ps_bra(values):
    if np.random.rand() < values[1] * values[2] * 0 + values[1] * (1 - values[2]) * 0.8 + (1 - values[1]) * values[
        2] * 0.6 + (1 - values[1]) * (1 - values[2]) * 1:
        values[3] = 1
    else:
        values[3] = 0
    return values
